 ...
 * 
 * <pre>
 * var cratewise = angular.module('cratewise', []);
 * cratewise.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://cratewise.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://cratewise.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('cratewise', []).config(function($sceDelegateProvider) {
 ...
 *        'http://cratewise.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="cratewiseController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("cratewiseController", function cratewiseController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('cratewiseWithSceDisabledcratewise', []).config(function($sceProvider) {
