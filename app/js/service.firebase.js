...
angular.module('cratewise.service.firebase', ['firebase', 'ngResource'])
...
// a simple utility to create references to Firebase paths
   .factory('firebaseRef', ['Firebase', 'FBURL', function(Firebase, FBURL) {
    ...
    .factory('companyData', function($resource){
      return $resource('https://cratewise.firebaseio.com/companies.json', {})
    })
