...
angular.module('cratewise.controllers', ['firebase', 'ngFlowGrid'])
   ...
   .controller('GridCtrl',['$scope','fgDelegate',function($scope,fgDelegate){
   ...
   .controller('DataCtrl', ['$scope', 'companyData', 'fgDelegate', function($scope, companyData, fgDelegate) {
      $scope.data ={};

      companyData.query(function(response) {
  ...
  .controller('CompanyCtrl', ['$scope', 'syncData', function($scope, syncData) {
      //method using firebase bindings instead of rest api
      var n = 3;
      $scope.companies = syncData('companies', n);
